...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/buttacuore2/NETWORKFREE/refs/heads/main/udp-custom/openvpn/squid3.conf"
...
echo "   - Dropbear                 : 109, 69" | tee -a log-install.txt
