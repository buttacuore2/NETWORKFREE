...
# domain random
#CDN="https://raw.githubusercontent.com/buttacuore2/NETWORKFREE/refs/heads/main/ssh"
cd /root
...
echo ""
clear
echo -e "$BBlue                          NF SETUP SUBDOMAIN VPS     $NC"
echo -e "$BYellow-------------------------------------------------------------------$NC"
...
#install ssh ovpn
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen      Install NF SSH Websocket           $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/buttacuore2/NETWORKFREE/refs/heads/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install NF XRAY              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/buttacuore2/NETWORKFREE/refs/heads/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/buttacuore2/NETWORKFREE/refs/heads/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/buttacuore2/NETWORKFREE/refs/heads/main/menu/versi  )
