...
show_vps_info() {
    ...
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e "\e[1;34m                     NF VIP AIO                    \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_cpu_ram_info() {
    ...
    echo -e "\e[1;34m                   NF CPU/RAM INFO                  \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_menu() {
    ...
    echo -e "\e[1;36m 2 \e[0m: Menu Vmess               \e[1;36m 6 \e[0m: Status Service"
    echo -e "\e[1;36m 3 \e[0m: Menu Trojan              \e[1;36m 7 \e[0m: Clear RAM Cache"
    echo -e "\e[1;36m 4 \e[0m: Menu Shadowsocks         \e[1;36m 8 \e[0m: Reboot VPS"
